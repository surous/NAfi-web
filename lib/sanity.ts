...
export const fallbackTestimonials: Testimonial[] = [
  {
    _id: "testimonial-extreme-gym",
    clientName: "Extreme Gym Management",
    role: "Leadership Team",
    company: "Extreme Gym",
    quote: "Partnering with NAFI Solutions helped streamline our operations and elevate our digital brand. Their responsiveness, technical expertise, and dedicated support made all the difference.",
    rating: 5,
  },
];
...
export const fallbackServices: Service[] = [
  ...
  },
  {
    ...
    description: "Specialized platforms and management software engineered by NAFI Solutions — featuring our flagship products GULBETOPS and EDUCORE.",
    icon: "Database",
    features: [
